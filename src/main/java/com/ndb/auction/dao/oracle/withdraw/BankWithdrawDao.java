...
public class BankWithdrawDao extends BaseOracleDao {
    ...
    public List<BankWithdrawRequest> selectByUser(int userId, int status) {
        String sql = "SELECT TBL_BANK_WITHDRAW.*, TBL_USER.EMAIL FROM TBL_BANK_WITHDRAW LEFT JOIN TBL_USER ON TBL_BANK_WITHDRAW.USER_ID = TBL_USER.ID WHERE TBL_BANK_WITHDRAW.USER_ID = ? AND TBL_BANK_WITHDRAW.IS_SHOW = ?";
    ...
    public BankWithdrawRequest selectById(int id, int status) {
        String sql = "SELECT TBL_BANK_WITHDRAW.*, TBL_USER.EMAIL FROM TBL_BANK_WITHDRAW LEFT JOIN TBL_USER ON TBL_BANK_WITHDRAW.USER_ID = TBL_USER.ID WHERE TBL_BANK_WITHDRAW.ID = ? AND TBL_BANK_WITHDRAW.IS_SHOW = ?";
