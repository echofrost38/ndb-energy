...
public class CryptoWithdrawDao extends BaseOracleDao {
    ...
    public List<? extends BaseWithdraw> selectByUser(int userId, int status) {
        var sql = "SELECT TBL_CRYPTO_WITHDRAW.*, TBL_USER.EMAIL from TBL_CRYPTO_WITHDRAW left JOIN TBL_USER on TBL_CRYPTO_WITHDRAW.USER_ID = TBL_USER.ID WHERE TBL_CRYPTO_WITHDRAW.USER_ID = ? AND TBL_CRYPTO_WITHDRAW.IS_SHOW = ?";
    ...
    public BaseWithdraw selectById(int id, int status) {
        String sql = "SELECT TBL_CRYPTO_WITHDRAW.*, TBL_USER.EMAIL from TBL_CRYPTO_WITHDRAW left JOIN TBL_USER on TBL_CRYPTO_WITHDRAW.USER_ID = TBL_USER.ID WHERE TBL_CRYPTO_WITHDRAW.ID=? AND TBL_CRYPTO_WITHDRAW.IS_SHOW = ?";
